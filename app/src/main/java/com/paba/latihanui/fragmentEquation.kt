...
class fragmentEquation : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val _tvEquation: TextView = view.findViewById(R.id.tvEquation)
        val _btnClear: Button = view.findViewById(R.id.btnClear)
